...
?>
        <script>
          ...
          document.location.href = "profil.php?id=" + idu;
        </script>
      <?php
      }
    }
    ...
    if (isset($_POST['newFirstName']) && !empty($_POST['newFirstName']) && !isset($erreurNewFirstName)) {
      ...
      <script>
        var idu = <?php echo json_encode($idUser); ?>;
        var create = alert("La modification de votre prénom à bien été prise en compte.");
        document.location.href = "profil.php?id=" + idu;
      </script>
    <?php
    }
    ...
    ?>
      <script>
        var idu = <?php echo json_encode($idUser); ?>;
        var create = alert("La modification de votre nom à bien été prise en compte.");
        document.location.href = "profil.php?id=" + idu;
      </script>
  <?php
    }
